 ...
 */
export function getThemeColor(theme: ChartTheme, shade: keyof typeof cyberColors.cyan = 500): string {
 ...
 */
export function getThemeColorRGB(theme: ChartTheme, shade: keyof typeof cyberColors.cyan = 500): { r: number; g: number; b: number } {
